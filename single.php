    ...
    <div id="main-block">
        <div class="left-line">
            <div id="content">
                    ...
                    <ul>
                    	<?php while (have_posts()) : the_post(); ?>
                        	<li <?php post_class() ?> id="post-<?php the_ID(); ?>">
                        		...
                        		<p><?php _e('Posted by', 'cloudy') ?> <?php the_author() ?> @ <?php the_time() ?> <?php edit_post_link('Edit'); ?></p>
                ...
                <?php else : ?>
                	<h3 class="t-center"><?php _e('Not Found', 'cloudy') ?></h2>
                	<p class="t-center"><?php _e('Sorry, but you are looking for something that isn\'t here.', 'cloudy') ?></p>
            	<?php endif; ?>
            </div><!--#content-->
        </div><!--.left-line-->
<?php get_footer(); ?>
